 ...
 */
final class Version20211030134522 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE customer_model ADD CONSTRAINT FK_19A007E2B3DFB97F FOREIGN KEY (message_models_id) REFERENCES message_model (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
