 ...
 */
final class Version20211030112515 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE message_model ADD CONSTRAINT FK_28338D329395C3F3 FOREIGN KEY (customer_id) REFERENCES customer_model (id)');
